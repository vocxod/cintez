...
/**
 * Base class that represents a row from the 'oc_category' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class OcCategory implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OcCategoryTableMap';
    ...
    /**
     * The value for the category_site_id field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Base\OcCategory object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OcCategory</code> instance.  If
     * <code>obj</code> is an instance of <code>OcCategory</code>, delegates to
     * <code>equals(OcCategory)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OcCategory The current object, for fluid interface
     */
    ...
    /**
     * Get the [category_site_id] column value.
     *
     * @return int
     */
    public function getCategorySiteId()
    {
        return $this->category_site_id;
    }
    ...
    public function setImage($v)
    {
        ...
        if ($this->image !== $v) {
            $this->image = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_IMAGE] = true;
        }
    ...
    public function setParentId($v)
    {
        ...
        if ($this->parent_id !== $v) {
            $this->parent_id = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_PARENT_ID] = true;
        }
    ...
    /**
     * Sets the value of the [top] column.
    ...
    public function setTop($v)
    {
        ...
        if ($this->top !== $v) {
            $this->top = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_TOP] = true;
        }
    ...
    public function setColumn($v)
    {
        ...
        if ($this->column !== $v) {
            $this->column = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_COLUMN] = true;
        }
    ...
    public function setSortOrder($v)
    {
        ...
        if ($this->sort_order !== $v) {
            $this->sort_order = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_SORT_ORDER] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_STATUS] = true;
        }
    ...
    public function setDateAdded($v)
    {
        ...
        if ($this->date_added !== null || $dt !== null) {
            if ($this->date_added === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_added->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[OcCategoryTableMap::COL_DATE_ADDED] = true;
            }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ( ($dt != $this->date_modified) // normalized values don't match
                ...
                $this->modifiedColumns[OcCategoryTableMap::COL_DATE_MODIFIED] = true;
            }
        } // if either are not null
    ...
    /**
     * Set the value of [category_site_id] column.
     *
     * @param int $v new value
     * @return $this|\OcCategory The current object (for fluent API support)
     */
    public function setCategorySiteId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->category_site_id !== $v) {
            $this->category_site_id = $v;
            $this->modifiedColumns[OcCategoryTableMap::COL_CATEGORY_SITE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OcCategoryTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->category_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OcCategoryTableMap::translateFieldName('Image', TableMap::TYPE_PHPNAME, $indexType)];
            $this->image = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OcCategoryTableMap::translateFieldName('ParentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->parent_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OcCategoryTableMap::translateFieldName('Top', TableMap::TYPE_PHPNAME, $indexType)];
            $this->top = (null !== $col) ? (boolean) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OcCategoryTableMap::translateFieldName('Column', TableMap::TYPE_PHPNAME, $indexType)];
            $this->column = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OcCategoryTableMap::translateFieldName('SortOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sort_order = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OcCategoryTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OcCategoryTableMap::translateFieldName('DateAdded', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_added = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : OcCategoryTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOcCategoryQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OcCategory::setDeleted()
     * @see OcCategory::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOcCategoryQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OcCategoryTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OcCategoryTableMap::COL_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'image';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_PARENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'parent_id';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_TOP)) {
            $modifiedColumns[':p' . $index++]  = 'top';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_COLUMN)) {
            $modifiedColumns[':p' . $index++]  = 'column';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_SORT_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'sort_order';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_DATE_ADDED)) {
            $modifiedColumns[':p' . $index++]  = 'date_added';
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_DATE_MODIFIED)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'parent_id':
                        ...
                        break;
                    case 'top':
                        $stmt->bindValue($identifier, (int) $this->top, PDO::PARAM_INT);
                        break;
                    case 'column':
    ...
    {
        $pos = OcCategoryTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $alreadyDumpedObjects['OcCategory'][$this->hashCode()] = true;
        $keys = OcCategoryTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OcCategoryTableMap::COL_CATEGORY_ID)) {
            $criteria->add(OcCategoryTableMap::COL_CATEGORY_ID, $this->category_id);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_IMAGE)) {
            $criteria->add(OcCategoryTableMap::COL_IMAGE, $this->image);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_PARENT_ID)) {
            $criteria->add(OcCategoryTableMap::COL_PARENT_ID, $this->parent_id);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_TOP)) {
            $criteria->add(OcCategoryTableMap::COL_TOP, $this->top);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_COLUMN)) {
            $criteria->add(OcCategoryTableMap::COL_COLUMN, $this->column);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_SORT_ORDER)) {
            $criteria->add(OcCategoryTableMap::COL_SORT_ORDER, $this->sort_order);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_STATUS)) {
            $criteria->add(OcCategoryTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_DATE_ADDED)) {
            $criteria->add(OcCategoryTableMap::COL_DATE_ADDED, $this->date_added);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(OcCategoryTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
        if ($this->isColumnModified(OcCategoryTableMap::COL_CATEGORY_SITE_ID)) {
    ...
    {
        $criteria = ChildOcCategoryQuery::create();
        $criteria->add(OcCategoryTableMap::COL_CATEGORY_ID, $this->category_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OcCategory (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OcCategory Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OcCategoryTableMap::DEFAULT_STRING_FORMAT);
    }
