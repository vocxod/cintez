 ...
 */
abstract class OcInformation implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OcInformationTableMap';
    ...
    /**
     * Initializes internal state of Base\OcInformation object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OcInformation</code> instance.  If
     * <code>obj</code> is an instance of <code>OcInformation</code>, delegates to
     * <code>equals(OcInformation)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OcInformation The current object, for fluid interface
     */
    ...
    public function setInformationId($v)
    {
        ...
        if ($this->information_id !== $v) {
            ...
            $this->modifiedColumns[OcInformationTableMap::COL_INFORMATION_ID] = true;
        }
    ...
    public function setBottom($v)
    {
        ...
        if ($this->bottom !== $v) {
            $this->bottom = $v;
            $this->modifiedColumns[OcInformationTableMap::COL_BOTTOM] = true;
        }
    ...
    public function setSortOrder($v)
    {
        ...
        if ($this->sort_order !== $v) {
            $this->sort_order = $v;
            $this->modifiedColumns[OcInformationTableMap::COL_SORT_ORDER] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[OcInformationTableMap::COL_STATUS] = true;
        }
    ...
    public function setArticeId($v)
    {
        ...
        if ($this->artice_id !== $v) {
            $this->artice_id = $v;
            $this->modifiedColumns[OcInformationTableMap::COL_ARTICE_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OcInformationTableMap::translateFieldName('InformationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->information_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OcInformationTableMap::translateFieldName('Bottom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bottom = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OcInformationTableMap::translateFieldName('SortOrder', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOcInformationQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OcInformation::setDeleted()
     * @see OcInformation::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOcInformationQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OcInformationTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OcInformationTableMap::COL_INFORMATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'information_id';
        }
        if ($this->isColumnModified(OcInformationTableMap::COL_BOTTOM)) {
            $modifiedColumns[':p' . $index++]  = 'bottom';
        }
        if ($this->isColumnModified(OcInformationTableMap::COL_SORT_ORDER)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'information_id':
                        ...
                        break;
                    case 'bottom':
                        $stmt->bindValue($identifier, $this->bottom, PDO::PARAM_INT);
                        break;
                    case 'sort_order':
    ...
    {
        $pos = OcInformationTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['OcInformation'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OcInformation'][$this->hashCode()] = true;
        $keys = OcInformationTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OcInformationTableMap::COL_INFORMATION_ID)) {
            $criteria->add(OcInformationTableMap::COL_INFORMATION_ID, $this->information_id);
        }
        if ($this->isColumnModified(OcInformationTableMap::COL_BOTTOM)) {
            $criteria->add(OcInformationTableMap::COL_BOTTOM, $this->bottom);
        }
        if ($this->isColumnModified(OcInformationTableMap::COL_SORT_ORDER)) {
            $criteria->add(OcInformationTableMap::COL_SORT_ORDER, $this->sort_order);
        }
        if ($this->isColumnModified(OcInformationTableMap::COL_STATUS)) {
    ...
    {
        $criteria = ChildOcInformationQuery::create();
        $criteria->add(OcInformationTableMap::COL_INFORMATION_ID, $this->information_id);
    ...
    /**
     * Generic method to set the primary key (information_id column).
     *
    ...
    {
        return null === $this->getInformationId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OcInformation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OcInformation Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OcInformationTableMap::DEFAULT_STRING_FORMAT);
    }
