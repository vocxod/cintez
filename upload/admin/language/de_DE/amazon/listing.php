<?php
/**
 * @version		$Id: listing.php 3488 2013-11-28 13:46:37Z mic $
...
$_['text_collectible_very_good']	= 'Sammlerstück - sehr guter Zustand';
$_['text_collectible_good']			= 'Sammlerstück - guter Zustand';
...
$_['column_image']					= 'Bild';
$_['column_asin']					= 'ASIN<span style="help">Amazon Standard Identifikationsnummer, siehe <a href="http://www.amazon.de/gp/seller/asin-upc-isbn-info.html" target="_blank">Amazons Abkürzungen</a></span>';
$_['column_name']					= 'Name';
...
$_['entry_start_selling']			= 'Verfügbar ab Datum';
$_['entry_restock_date']			= 'Datum Lagerauffüllung';
$_['entry_country_of_origin']		= 'Herkunftsland';
$_['entry_release_date']			= 'Veröffentlichungsdatum';
$_['entry_from']					= 'Von';
$_['entry_to']						= 'Bis';

$_['help_sku']						= 'Einmalige Artikelnummer zugewiesen durch Händler';
$_['help_restock_date']				= 'Datum der spätestmöglichen Auslieferung von Bestellrückständen. Datum sollte nicht mehr als 30 Tage betragen ansonsten die Bestellung automatisch storniert wird.';
...
$_['error_marketplace_missing']		= 'Bitte eine Marktplatz wählen';
...
$_['text_error_connecting']			= 'Hinweis: es gibt ein Problem mit der Verbindung zum Welfords API-Server. BItte die OpenBay Pro Amazon Einstellungen überprüfen. Besteht das Problem weiterhin, bitte den Support von Welford kontaktieren.';
...
/* Item links tab */
$_['item_links_description']		= 'Hier können nicht bereits bei Amazon gelistete Produkte bearbeitet werden. Dies erlaubt eine Lagerstandskontrolle zwischen den aktivierten Marktplätzen. Wenn openStock installier ist, können Links zu einzelnen Amazon SKUs erstellt werden (laden von Produkten von Shop nach Amazon erstellt diese Links automatisch)';
...
$_['uploaded_alert_text']			= 'Gespeicherte Listing(s) hochgeladen!';
$_['upload_failed']					= 'Produkt mit SKU: "%s" nicht hochgeladen - Grund: "%s" > Hochladen abgebrochen.';
...
$_['option_default']				= '-- Option wählen --';
