<?php
/**
 * @version		$Id: pp_standard.php 3535 2014-01-09 10:26:02Z mic $
...
$_['entry_test']            = 'Testmodus<span class="help">Je nach gewählter Emailadresse hier den richtigen Modus aktivieren<br />Im Testmodus werden Transaktionen nur simuliert, dazu ist jedoch ein eigener Account bei PayPal notwendig (Sandbox)</span>';
$_['entry_transaction']     = 'Transaktionsmethode';
$_['entry_pdt_token']       = 'PDT Token<span class="help">PDT Token wird für zusätzliche Sicherheit und Zuverlässigkeit verwendet. Informationen zum Aktivieren von PDT <a href="https://cms.paypal.com/us/cgi-bin/?&cmd=_render-content&content_ID=developer/howto_html_paymentdatatransfer" alt="">hier</a></span>';
...
$_['entry_failed_status']               = 'Auftragsstatus Fehlgeschlagen<span class="help">Die Zahlung ist fehlgeschlagen - Zahlung konnte nicht vom Kundenkonto abgebucht werden.</span>';
