<?php
/**
 * @version		$Id: pp_pro_uk.php 3488 2013-11-28 13:46:37Z mic $
...
// Heading
$_['heading_title']      = 'PayPal Pro (UK)';

// Text
$_['text_payment']       = 'Zahlung';
$_['text_success']       = 'Datensatz erfolgreich geändert!';
$_['text_pp_pro_uk']     = '<a href="https://www.paypal.com/uk/mrb/pal=W9TBB5DTD6QJW" target="_blank"><img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro (UK)" title="PayPal Pro (UK)" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_authorization'] = 'Genehmigung';
$_['text_sale']          = 'Verkauf';

// Entry
$_['entry_vendor']       = 'Anbieter<span class="help">Die Händlernummer zum Login auf PayPal Payments Pro (UK).</span>';
