<?php
/**
 * @version		$Id: setting.php 3556 2014-02-16 16:14:51Z mic $
...
$_['entry_address']             = 'Adresse<span class="help">Achtung!<br />Innerhalb der EU muss die Adresse existieren und darf KEIN Postfach sein!</span>';
$_['entry_email']               = 'Email';
$_['entry_telephone']           = 'Telefon<span class="help">Achtung!<br />Innerhalb der EU muss eine erreichbare Telefonnummer angegeben sein!</span>';
$_['entry_fax']                 = 'Fax';
$_['entry_title']               = 'Shopname';
$_['entry_meta_description']    = 'Metatag Beschreibung<span class="help">Kurze Beschreibung für Suchmaschinen</span>';
$_['entry_layout']              = 'Standardlayout';
$_['entry_template']            = 'Vorlage';
$_['entry_country']             = 'Land<span class="help">Land in dem dieses Geschäft seinen Stammsitz hat.<br />Wird u.a. zur Steuerberechnung verwendet (siehe auch Reiter `Optionen > Steuern`)</span>';
$_['entry_zone']                = 'Bundesland';
$_['entry_language']            = 'Benutzersprache:<span class="help">Sind mehrere Sprachen installiert und aktiv, kann der Besucher mit dem Sprachauswahlfeld wählen</span>';
$_['entry_admin_language']      = 'Adminsprache';
$_['entry_currency']            = 'Währung<span class="help">Standardwährung.<br />Bei Änderung Browsercache und Cookies löschen um die Änderungen zu sehen.</span>';
...
$_['entry_length_class']        = 'Vorgabe Länge<span class="help">Standard bei Neuanlage, kann bei Produkt selbst geändert werden</span>';
$_['entry_weight_class']        = 'Vorgabe Gewicht<span class="help">Standard bei Neuanlage, kann bei Produkt selbst geändert werden</span>';
...
$_['entry_product_count']       = 'Kategoriezähler<span class="help">Zeige Anzahl der Produkte innerhalb Unterkategorien in Menüauswahl.<br /><b>Achtung! Bei vielen Unterkategorien kann das zu einer Serverüberbelastung und langen Seitenaufbau führen!!</b></span>';
...
$_['entry_tax_default']         = 'Verwende Geschäftsadresse<span class="help">Falls Besucher nicht eingeloggt ist wird die Geschäftsadresse als Basis zur Steuerberechnung verwendet (auf Versand- oder Rechnungsadresse)<br />Siehe auch Reiter `Lokales`</span>';
$_['entry_tax_customer']        = 'Verwende Kundenadresse<span class="help">Ist Kunde eingeloggt wird entweder dessen Versand- oder Rechnungsadresse als Basis der Steuerberechnung verwendet</span>';
...
$_['entry_account']             = 'Text bei Registrierung<span class="help">Neue Kunden müssen diese Bedingungen akzeptieren damit sie sich registrieren können</span>';
...
$_['entry_order_edit']          = 'Auftragsnachbearbeitung<span class="help">Anzahl der Tage eine Bearbeitung von Aufträgen möglich ist.<br />Notwendig da Preise und Konditionen geändert werden könnten und dann der Auftrag nicht mehr stimmt</span>';
...
$_['entry_logo']                = 'Shoplogo<span class="help">Ändern sich die Bildmasse, muss auch die Vorlage dementsprechend manuell angepasst werden!</span>';
...
$_['entry_mail_parameter']      = 'Mailparameter<span class="help">Wurde "php.Mail" gewählt, können hier zusätzliche Mailparameter hinzugefügt werden (z.B. "-femail@storeaddress.com")</span>';
...
$_['entry_seo_url']             = 'Verwende SEO URLs<span class="help">Um SEO URLs zu verwenden, muss bei *nix_Servern das Apachemodul mod_rewrite installiert sein und die htaccess.txt in .htaccess umbenannt werden.<br />Für MS-IIS gibt es andere Richtlinien<br />Siehe <a href="http://de.wikipedia.org/wiki/Mod_rewrite" target="_blank">mod_rewrite bei Wikipedia</a></span>';
...
$_['error_title']                   = 'Geschäftsname muss zwischen 3 und 32 Zeichen lang sein';
