<?php
/**
 * @version		$Id: store.php 3556 2014-02-16 16:14:51Z mic $
...
// Entry
$_['entry_url']						= 'Shop-URL<span class="help">URL für diesen Shop, muss mit einem Slash \'/\' abschliessen.<br />Beispiel: http://www.meinedomain.com/path/<br /><br />Kein Verzeichniss für neuen Shop verwenden.<br /><strong>Es sollte immer entweder auf eine andere Domain oder Subdomain des Hauptshops verwiesen werden</strong>.</span>';
$_['entry_ssl']						= 'Shop-URL https://<span class="help">SSL-URL für diesen Shop, muss mit einem Slash \'/\' abschliessen.<br />Beispiel: https://www.meinedomain.com/path/<br /><br />Kein Verzeichniss für neuen Shop verwenden.<br /><strong>Es sollte immer entweder auf eine andere Domain oder Subdomain des Hauptshops verwiesen werden</strong>.</span>';
...
$_['entry_tax_default']				= 'Verwende Geschäftsadresse<span class="help">Falls Besucher nicht eingeloggt ist wird die Geschäftsadresse als Steuerberechnungsbasis verwendet</span>';
$_['entry_tax_customer']			= 'Verwende Kundenadresse<span class="help">Ist Kunde eingeloggt, verwende dessen Standardadresse als Steuerberechnungbasis (entweder Versand- oder Rechnungsadresse)</span>';
...
$_['entry_secure']					= 'SSL<span class="help">Soll eine SSL-Verbindung verwendet werden (empfohlen!), hier aktivieren (Zertifikat muss zuvor am Server installiert sein!)</span>';
