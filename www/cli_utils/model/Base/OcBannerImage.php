...
/**
 * Base class that represents a row from the 'oc_banner_image' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class OcBannerImage implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OcBannerImageTableMap';
    ...
    /**
     * The value for the banner_image_id field.
     *
     * @var        int
     */
    ...
    /**
     * Initializes internal state of Base\OcBannerImage object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>OcBannerImage</code> instance.  If
     * <code>obj</code> is an instance of <code>OcBannerImage</code>, delegates to
     * <code>equals(OcBannerImage)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OcBannerImage The current object, for fluid interface
     */
    ...
    /**
     * Get the [banner_image_id] column value.
     *
     * @return int
     */
     ...
     */
    public function setBannerImageId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->banner_image_id !== $v) {
            $this->banner_image_id = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_BANNER_IMAGE_ID] = true;
        }
    ...
    public function setBannerId($v)
    {
        ...
        if ($this->banner_id !== $v) {
            $this->banner_id = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_BANNER_ID] = true;
        }
    ...
    public function setLanguageId($v)
    {
        ...
        if ($this->language_id !== $v) {
            $this->language_id = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_LANGUAGE_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_TITLE] = true;
        }
    ...
    public function setLink($v)
    {
        ...
        if ($this->link !== $v) {
            $this->link = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_LINK] = true;
        }
    ...
    public function setImage($v)
    {
        ...
        if ($this->image !== $v) {
            $this->image = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_IMAGE] = true;
        }
    ...
    public function setSortOrder($v)
    {
        ...
        if ($this->sort_order !== $v) {
            $this->sort_order = $v;
            $this->modifiedColumns[OcBannerImageTableMap::COL_SORT_ORDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OcBannerImageTableMap::translateFieldName('BannerImageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->banner_image_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OcBannerImageTableMap::translateFieldName('BannerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->banner_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OcBannerImageTableMap::translateFieldName('LanguageId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->language_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OcBannerImageTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OcBannerImageTableMap::translateFieldName('Link', TableMap::TYPE_PHPNAME, $indexType)];
            $this->link = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OcBannerImageTableMap::translateFieldName('Image', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOcBannerImageQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OcBannerImage::setDeleted()
     * @see OcBannerImage::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOcBannerImageQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OcBannerImageTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OcBannerImageTableMap::COL_BANNER_IMAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'banner_image_id';
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_BANNER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'banner_id';
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_LANGUAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'language_id';
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_LINK)) {
            $modifiedColumns[':p' . $index++]  = 'link';
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_IMAGE)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'banner_image_id':
                        $stmt->bindValue($identifier, $this->banner_image_id, PDO::PARAM_INT);
                        break;
                    case 'banner_id':
    ...
    {
        $pos = OcBannerImageTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['OcBannerImage'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OcBannerImage'][$this->hashCode()] = true;
        $keys = OcBannerImageTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getBannerImageId(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setBannerImageId($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OcBannerImageTableMap::COL_BANNER_IMAGE_ID)) {
            $criteria->add(OcBannerImageTableMap::COL_BANNER_IMAGE_ID, $this->banner_image_id);
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_BANNER_ID)) {
            $criteria->add(OcBannerImageTableMap::COL_BANNER_ID, $this->banner_id);
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_LANGUAGE_ID)) {
            $criteria->add(OcBannerImageTableMap::COL_LANGUAGE_ID, $this->language_id);
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_TITLE)) {
            $criteria->add(OcBannerImageTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_LINK)) {
            $criteria->add(OcBannerImageTableMap::COL_LINK, $this->link);
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_IMAGE)) {
            $criteria->add(OcBannerImageTableMap::COL_IMAGE, $this->image);
        }
        if ($this->isColumnModified(OcBannerImageTableMap::COL_SORT_ORDER)) {
    ...
    {
        $criteria = ChildOcBannerImageQuery::create();
        $criteria->add(OcBannerImageTableMap::COL_BANNER_IMAGE_ID, $this->banner_image_id);
    ...
    {
        $validPk = null !== $this->getBannerImageId();
    ...
    /**
     * Generic method to set the primary key (banner_image_id column).
     *
    ...
    {
        return null === $this->getBannerImageId();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OcBannerImage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OcBannerImage Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OcBannerImageTableMap::DEFAULT_STRING_FORMAT);
    }
