...
/*
строго говоря - это группа атрибутов GROUP_ID = 8 (отрасль)
*/

class ModelCatalogIndustry extends Model {

	public function getIndustry( $i_language_id = 4 ){

		$s_sql_select = "SELECT a.attribute_id, b.name FROM oc_attribute AS a LEFT JOIN oc_attribute_description AS b ON a.attribute_id=b.attribute_id WHERE a.attribute_group_id = 8 AND b.language_id='$i_language_id' ";
